 ...
 *@introduction
 */
abstract class BaseXRecyclerViewFragmentNew<T : ViewDataBinding, VM : BaseViewModel, D> : BaseFragmentNew<T,VM>(),
    ...
    //列表recyclerView
    protected val mRecyclerView: MyXRecyclerView by lazy {
        getRecyclerView()
    }
    ...
    //列表排列样式
    protected open fun initLayoutManger(): RecyclerView.LayoutManager = LinearLayoutManager(requireContext())
